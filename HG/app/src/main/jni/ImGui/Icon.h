...
#define ICON_FA_ARROW_LEFT  "\xef\x81\x88"  // Left Arrow (⬅️)
#define ICON_FA_ARROW_RIGHT "\xef\x81\x89"  // Right Arrow (➡️)
#define ICON_FA_REFRESH "\xef\x80\xa1"  // Refresh (🔄)
#define ICON_FA_SYNC "\xef\x80\xa2"     // Sync (🔄)
#define ICON_MIN_FA 0xe000
#define ICON_MAX_FA 0xf8ff
#define ICON_FA_BACKSPACE "\xef\x95\x9a"  // Unicode for Backspace Icon (⌫)
#define ICON_FA_TRASH "\xef\x8b\xad"  // Delete (🗑)
