...
bool ImGui::ShowStyleSelector(const char* label)
{
    ...
    if (ImGui::Combo(label, &style_idx, "Dark\0Light\0Classic\0"))
    {
       ...
       case 0: ImGui::StyleColorsLight(); break;
        ...
        case 2: ImGui::StyleColorsCyan(); break;
        case 3: ImGui::StyleColorsRed(); break;
        case 4: ImGui::StyleColorsBlue(); break;
        case 5: ImGui::StyleColorsYellow(); break;
        case 6: ImGui::StyleColorsPink(); break;
        case 7: ImGui::StyleColorsWhite(); break;
